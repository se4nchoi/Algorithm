...
fruits = pd.read_table('2021_CPS_festival/fruit_data_with_colors.txt')
...
"""
Box plot for each numeric variable will give us a 
clearer idea of the distribution of the input variables:
"""
...
"""
Create test/training sets and apply scale
"""
...
# confusion matrix to see that KNN was the most accurate
# with no errors in test set
